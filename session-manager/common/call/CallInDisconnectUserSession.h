...
#ifndef _OGON_SMGR_CALL_CALLINDISCONNECTUSERSESSION_H_
#define _OGON_SMGR_CALL_CALLINDISCONNECTUSERSESSION_H_
...
#endif /* _OGON_SMGR_CALL_CALLINDISCONNECTUSERSESSION_H_ */
