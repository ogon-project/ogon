...
#ifndef _OGON_SMGR_CALL_CALLOUTOTSAPISTOPREMOTECONTROL_H_
#define _OGON_SMGR_CALL_CALLOUTOTSAPISTOPREMOTECONTROL_H_
...
#endif /* _OGON_SMGR_CALL_CALLOUTOTSAPISTOPREMOTECONTROL_H_ */
