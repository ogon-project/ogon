...
#ifndef OGON_SMGR_CALL_CALLOUTDISCONNECTUSERSESSION_H_
#define OGON_SMGR_CALL_CALLOUTDISCONNECTUSERSESSION_H_
...
#endif /* OGON_SMGR_CALL_CALLOUTDISCONNECTUSERSESSION_H_ */
