...
#ifndef OGON_SMGR_CALL_CALLOUTOTSAPISTARTREMOTECONTROL_H_
#define OGON_SMGR_CALL_CALLOUTOTSAPISTARTREMOTECONTROL_H_
...
namespace ogon { namespace sessionmanager { namespace call {
	...
	typedef std::shared_ptr<CallOutOtsStartRemoteControl> CallOutOtsStartRemoteControlPtr;

} /*call*/ } /*sessionmanager*/ } /*ogon*/

namespace callNS = ogon::sessionmanager::call;

#endif /* OGON_SMGR_CALL_CALLOUTOTSAPISTARTREMOTECONTROL_H_ */
