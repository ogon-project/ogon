...
#ifndef _OGON_SMGR_CALL_CALLOUTOTSAPIVIRTUALCHANNELCLOSE_H_
#define _OGON_SMGR_CALL_CALLOUTOTSAPIVIRTUALCHANNELCLOSE_H_
...
#endif /* _OGON_SMGR_CALL_CALLOUTOTSAPIVIRTUALCHANNELCLOSE_H_ */
