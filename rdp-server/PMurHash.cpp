...
#define READ_UINT32(ptr) (__builtin_bswap32(*((const uint32_t *)(ptr))))
#else
...
/* cnt=bytes to process, h1=name of h1 var, c=carry, n=bytes in c,
 * ptr/len=payload */
...
void PMurHash32_Process(
	...
	/* We're now aligned. Process in aligned blocks. Specialise for each
	 * possible carry count */
	end = ptr + len / 4 * 4;
...
/* Finalize a hash. To match the original Murmur3A the total_length must be
 * provided */
